...
import { HiOutlineBookOpen, HiOutlineChartBar, HiOutlineTrophy, HiOutlineUser, HiOutlineKey } from 'react-icons/hi2';
import './Student.css';
...
export const StudentDashboard = () => {
  ...
  const actions = [
    ...
    { to: '/student/leaderboard', icon: <HiOutlineTrophy />, title: 'Leaderboard', desc: 'See where you stand among peers' },
